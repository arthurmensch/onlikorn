...
Problem \eqref{eq:dual} can be solved by alternated maximization, which is itself performed in closed form. At iteration $t$, the updates are simply\todo{there is no - sign in front of the C transform, right?}
\begin{align}

...
soft $C$-transforms. Online Sinkhorn estimates and record a distance matrix
...
and similarly for each $p_i$. This corresponds to performing one step of the
 ...
 \beta_t$. This reduces the dual cost $F_{ \bar \alpha, \bar \beta}(f_t, g_t)$,
...
we consider operates in an infinite-dimensional space, which is valid under mild conditions \citep{hsieh2018finding}.

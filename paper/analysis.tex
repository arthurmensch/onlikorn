...
existing asymptotic rates from \cite{2019-Genevay-aistats}, for any Lipschitz cost. We derive non-asymptotic rates in \autoref{sec:proof_prop_convergence} (see \eqref{eq:non-asymptotic}), that explicits the

...
\begin{figure}[t]
    ...
    \includegraphics{random_0.1_test_}
    
    $\varepsilon = 0.01$
    \includegraphics{random_0.01_test_}

    $\varepsilon = 0.001$

    \includegraphics{random_0.001_test_}

    $\varepsilon = 0.0001$

    \includegraphics{random_0.0001_test_}
...
\begin{figure}[t]
        ...
        \includegraphics{online_0.1_False_test_gaussian}
        
        $\varepsilon = 0.01$
        \includegraphics{online_0.01_False_test_gaussian}
    
        $\varepsilon = 0.001$
    
        \includegraphics{online_0.001_False_test_gaussian}
    
        $\varepsilon = 0.0001$
    
        \includegraphics{online_0.0001_False_test_gaussian}
...
\begin{figure}[htbp]
    ...
    \includegraphics{quiver_os_1e8}

    \includegraphics{quiver_subsampled_1e8}

    \includegraphics{quiver_ref}

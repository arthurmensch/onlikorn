...
\begin{figure}[t]
    ...
    \includegraphics[width=\linewidth]{online_0_1_False_test.pdf}
    ...
    \includegraphics[width=\linewidth]{online_0_001_False_test.pdf}

    $\varepsilon = 0.0001$

    \includegraphics[width=\linewidth]{online_0_0001_False_test.pdf}
    \end{widepage}
...
\begin{figure}[t]
    ...
    \includegraphics[width=\linewidth]{online_0_1_True_test.pdf}
    
    $\varepsilon = 0.01$

    \includegraphics[width=\linewidth]{online_0_01_True_test.pdf}

    $\varepsilon = 0.001$

    \includegraphics[width=\linewidth]{online_0_001_True_test.pdf}

    $\varepsilon = 0.0001$

    \includegraphics[width=\linewidth]{online_0_0001_True_test.pdf}
    \end{widepage}
...
\begin{figure}[t]
    \begin{widepage}
    \centering
    \includegraphics[width=\linewidth]{random_0_1_test_.pdf}
    
    $\varepsilon = 0.01$

    \includegraphics[width=\linewidth]{random_0_01_test_.pdf}

    $\varepsilon = 0.001$

    \includegraphics[width=\linewidth]{random_0_001_test_.pdf}

    $\varepsilon = 0.0001$

    \includegraphics[width=\linewidth]{random_0_0001_test_.pdf}
    \end{widepage}
...
\begin{figure}[t]
    \begin{widepage}
        ...
        \includegraphics[width=\linewidth]{online_0_1_False_test_gaussian.pdf}
        
        $\varepsilon = 0.01$

        \includegraphics[width=\linewidth]{online_0_01_False_test_gaussian.pdf}
    
        $\varepsilon = 0.001$
    
        \includegraphics[width=\linewidth]{online_0_001_False_test_gaussian.pdf}
    
        $\varepsilon = 0.0001$
    
        \includegraphics[width=\linewidth]{online_0_0001_False_test_gaussian.pdf}
    \end{widepage}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=\linewidth]{quiver_os_1e8.pdf}

    \includegraphics[width=\linewidth]{quiver_subsampled_1e8.pdf}

    \includegraphics[width=\linewidth]{quiver_ref.pdf}
...
\begin{figure}[t]
    ...
    \includegraphics[width=\linewidth]{online+full_0_1_err.pdf}
    
    $\varepsilon = 0.01$

    \includegraphics[width=\linewidth]{online+full_0_01_err.pdf}
    ...
    \includegraphics[width=\linewidth]{online+full_0_0001_err.pdf}

...
iterations, as required for consistent estimation.
...
is similar to Polyak-Ruppert  averaging \cite{ruppert1988efficient} for stochastic approximation. We test avering in experiments but leave its analysis for future work.
...
samples and on the stored distance matrix.  For this, we update $\hat f_{t+1} = \Ctrans{g_t}{\bar \beta_t}$ and

...
optimal potential $\EE_{\hat \alpha_n \sim \alpha, \hat \beta_n
\sim \beta}[f^\star(\hat \alpha_n, \hat \beta_n)]$ under sampling. Our algorithm estimates the
true potential functions (up to a constant) and overcomes the sampling
bias.